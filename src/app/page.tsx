  ...
  return (
    <div>
      ...
      <section className="relative bg-[#0B0B0B] overflow-hidden">
        ...
        <div className="absolute bottom-0 right-0 w-[600px] h-[600px] bg-orange-600/10 rounded-full blur-[140px] pointer-events-none" />
        {/* Subtle grid pattern */}
        <div className="absolute inset-0 opacity-[0.03] pointer-events-none" style={{ backgroundImage: "linear-gradient(rgba(255,255,255,.5) 1px, transparent 1px), linear-gradient(90deg, rgba(255,255,255,.5) 1px, transparent 1px)", backgroundSize: "50px 50px" }} />

        <div className="relative max-w-7xl mx-auto px-4 md:px-6 pt-8 md:pt-20 pb-6 md:pb-16">
          <div className="grid md:grid-cols-2 gap-8 md:gap-10 items-center">
            ...
            <div className="order-2 md:order-1">
              ...
              {/* Headline */}
              <h1 className="text-[1.875rem] md:text-[3.75rem] font-extrabold text-white leading-[1.1] tracking-tight">
                Buy Pre-Owned Cars{" "}
              ...
              {/* Subtext */}
              <p className="text-sm md:text-lg text-slate-300/90 mt-4 md:mt-6 leading-relaxed max-w-xl">
              ...
              <div className="flex flex-col sm:flex-row gap-3 mt-6 md:mt-8">
                ...
                <Link
                  href="/cars"
                  className="inline-flex items-center justify-center gap-2 border border-white/20 bg-white/5 backdrop-blur-sm text-white font-semibold px-6 md:px-8 py-3.5 md:py-4 rounded-xl text-sm md:text-base hover:bg-white/10 hover:border-white/40 transition-all duration-300"
                >
              ...
              <div className="flex flex-wrap items-center gap-x-4 gap-y-2 md:gap-x-6 mt-6 md:mt-10">
                {[
                  ...
                  <span key={text} className="flex items-center gap-1.5 text-slate-300 text-[0.7rem] md:text-xs font-medium">
                    <span className="w-4 h-4 md:w-5 md:h-5 rounded-full bg-gradient-to-br from-[#FF6A00] to-[#FF8C00] flex items-center justify-center flex-shrink-0 shadow-[0_0_12px_rgba(255,106,0,0.5)]">
            ...
            {/* Right: Luxury Car Image */}
            <div className="order-1 md:order-2 relative">
              <div className="relative aspect-[4/3] md:aspect-[5/4]">
                {/* Glow behind car */}
                <div className="absolute inset-0 bg-gradient-radial from-orange-500/20 via-orange-500/5 to-transparent blur-2xl" />
                {/* Car image */}
                <img
                  src="https://images.unsplash.com/photo-1555215695-3004980ad54e?w=1200&q=80"
                  alt="Luxury pre-owned car"
                  className="relative w-full h-full object-cover object-center rounded-2xl md:rounded-3xl"
                  loading="eager"
                  fetchPriority="high"
                />
                {/* Dark vignette overlay */}
                <div className="absolute inset-0 bg-gradient-to-t from-[#0B0B0B]/60 via-transparent to-transparent rounded-2xl md:rounded-3xl pointer-events-none" />
                {/* Floating rating card */}
                <div className="absolute top-3 right-3 md:top-5 md:right-5 bg-black/60 backdrop-blur-md border border-white/10 rounded-xl px-3 py-2 md:px-4 md:py-2.5 flex items-center gap-2">
                  <svg className="w-4 h-4 md:w-5 md:h-5 text-[#FF8C00]" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M11.48 3.499a.562.562 0 0 1 1.04 0l2.125 5.111a.563.563 0 0 0 .475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 0 0-.182.557l1.285 5.385a.562.562 0 0 1-.84.61l-4.725-2.885a.562.562 0 0 0-.586 0L6.982 20.54a.562.562 0 0 1-.84-.61l1.285-5.386a.562.562 0 0 0-.182-.557l-4.204-3.602a.562.562 0 0 1 .321-.988l5.518-.442a.563.563 0 0 0 .475-.345L11.48 3.5Z" />
                  </svg>
                  <div className="text-white">
                    <p className="text-xs md:text-sm font-bold leading-none">4.9/5</p>
                    <p className="text-[0.6rem] md:text-[0.65rem] text-slate-400 mt-0.5">Trusted by 50K+</p>
                  </div>
                </div>
              </div>
            </div>
