    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center px-4 bg-slate-50">
        <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full text-center">
          ...
          <p className="text-slate-500 text-sm mb-6">Sign in with Google to sell your car. This helps us verify your identity and contact you with offers.</p>
          <button
            onClick={handleGoogleSignIn}
            disabled={signingIn}
            className="w-full flex items-center justify-center gap-3 px-6 py-3.5 bg-white border-2 border-slate-200 rounded-xl hover:bg-slate-50 hover:border-slate-300 transition-all font-semibold text-slate-700 disabled:opacity-50 mb-3"
          >
              ...
              <div className="space-y-4">
                ...
                {!isLoggedIn && (
                  <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 text-center">
                    ...
                    <button onClick={handleGoogleSignIn} className="text-orange-600 text-sm font-bold underline mt-1 inline-block">Sign in with Google</button>
                  </div>
                )}
