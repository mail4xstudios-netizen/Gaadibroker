    ...
    <footer className="bg-slate-900 text-slate-300">
      ...
      <div className="border-t border-slate-800">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-5 flex flex-col md:flex-row items-center justify-between gap-3">
          <p className="text-sm text-slate-500">&copy; 2026 GaadiBroker. All rights reserved.</p>
          <div className="flex items-center gap-5">
            <Link href="/privacy" className="text-sm text-slate-500 hover:text-orange-400 transition-colors">
              Privacy Policy
            </Link>
            <span className="w-1 h-1 bg-slate-700 rounded-full" />
            <Link href="/terms" className="text-sm text-slate-500 hover:text-orange-400 transition-colors">
              Terms & Conditions
            </Link>
          </div>
        </div>
