...
export default function SearchBar() {
  ...
  const selectClass = "w-full px-3 md:px-4 py-3 md:py-3.5 bg-white border border-slate-200 rounded-xl text-slate-700 text-sm font-medium focus:outline-none focus:border-orange-400 focus:ring-2 focus:ring-orange-100 transition-all appearance-none cursor-pointer";

  return (
    <div className="bg-white/95 backdrop-blur-xl rounded-xl md:rounded-2xl shadow-[0_8px_40px_rgba(0,0,0,.12)] p-3 md:p-6 max-w-4xl border border-white/50">
      ...
      <div className="grid grid-cols-3 md:grid-cols-4 gap-1.5 md:gap-3">
        <div className="relative">
          <label className="hidden md:block text-[0.6875rem] font-semibold text-slate-500 uppercase tracking-wider mb-1.5">Brand</label>
        ...
        <div>
          <label className="hidden md:block text-[0.6875rem] font-semibold text-slate-500 uppercase tracking-wider mb-1.5">Budget</label>
        ...
        <div>
          <label className="hidden md:block text-[0.6875rem] font-semibold text-slate-500 uppercase tracking-wider mb-1.5">Fuel Type</label>
        ...
        <div className="col-span-3 md:col-span-1">
          <label className="hidden md:block text-[0.6875rem] font-semibold text-slate-500 uppercase tracking-wider mb-1.5">&nbsp;</label>
          <button
            onClick={handleSearch}
            className="w-full btn-primary rounded-xl flex items-center justify-center gap-2 !py-2.5 md:!py-3.5 text-sm"
          >
      ...
      {/* Quick filter chips */}
      <div className="hidden sm:flex flex-wrap gap-2 mt-4 pt-4 border-t border-slate-100">
